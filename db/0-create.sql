...
CREATE SCHEMA IF NOT EXISTS olsztyn;
GRANT USAGE ON SCHEMA olsztyn TO data_service;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA olsztyn TO data_service;
ALTER DEFAULT PRIVILEGES IN SCHEMA olsztyn GRANT ALL ON TABLES TO data_service;

CREATE TABLE olsztyn.live (
